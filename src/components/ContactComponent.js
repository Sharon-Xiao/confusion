    		...
    		<div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                        <h5>Our Address</h5>
                        <address>121, Clear Water Bay Road<br />Clear Water Bay, Kowloon<br />HONG KONG<br />
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='email' id="email" name="email" placeholder="Email" value={this.state.email} valid={errors.emial===''} invalid={errors.email!==''} onBlur={this.handleBlur('email')} onChange={this.handleInputChange} />
                            ...
                            <FormGroup row>
                                <Col md={{size:10, offset:2}}>
                                    <Button typr="submit" color="primary">Send Feedback</Button>
                                </Col>
                            </FormGroup>
                        </Form>
                    </div>
